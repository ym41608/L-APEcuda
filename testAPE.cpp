...
int main() {
  Mat marker = cv::imread("img/bu.png");
  Mat img = cv::imread("img/gg1.png");
  if(!marker.data ) {
  ...
  APE(ex_mat, marker, img, 800, 800, 319.5, 319.5, 0.5, 3.0, 8.5, 0.25, false, true);
  drawCoordinate(ex_mat, 800, 800, 319.5, 319.5, img);
  //imshow("img", img);
  //waitKey(0);
